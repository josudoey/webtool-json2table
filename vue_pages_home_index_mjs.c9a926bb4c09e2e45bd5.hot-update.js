...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    translate () {
      try {
        this.value = json5__WEBPACK_IMPORTED_MODULE_0__.parse(getMongoJSON(this.text), (k, v) => {
          console.log(k)
          console.log(v)
        })
        this.save()
...
//# sourceMappingURL=vue_pages_home_index_mjs.c9a926bb4c09e2e45bd5.hot-update.js.map